...
namespace Smrf.XmlLib
{
    ...
    public class FacebookGraphDescription : GraphDescriptionDocument
    {
        //*************************************************************************
        ...
        public FacebookGraphDescription
        (
            String graphType,
            String personalFanPageGroupName
        )
        :
        base()
        {
            AppendGraphTypeXmlNode(graphType);
            AppendGraphSourceXmlNode("Facebook");
            AppendGraphTermXmlNode(personalFanPageGroupName);
        }
