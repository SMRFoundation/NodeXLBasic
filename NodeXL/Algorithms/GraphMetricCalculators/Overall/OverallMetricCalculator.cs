...
///
/// <remarks>
/// The calculations for <see cref="OverallMetrics.GraphDensity" />, <see
/// cref="OverallMetrics.ReciprocatedVertexPairRatio" /> and <see
/// cref="OverallMetrics.ReciprocatedEdgeRatio" /> skip all self-loops and
/// duplicate edges, which would render the metrics invalid.
/// </remarks>
//*****************************************************************************
...
public class OverallMetricCalculator : GraphMetricCalculatorBase
{
    ...
    //*************************************************************************
    //  Method: CalculateSnapOverallMetrics()
    //
    /// <summary>
