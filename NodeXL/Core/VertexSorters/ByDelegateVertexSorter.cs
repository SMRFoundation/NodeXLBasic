...
/// property to a delegate that compares two vertices, then call the <see
/// cref="IVertexSorter.Sort" /> method.
///
/// <para>
...
public class ByDelegateVertexSorter : VertexSorterBase
{
    ...
    /// call <see cref="IVertexSorter.Sort" />, the returned array will be
