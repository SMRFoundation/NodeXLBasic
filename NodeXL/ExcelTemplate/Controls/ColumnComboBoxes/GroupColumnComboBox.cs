...
{
//*****************************************************************************
//  Class: GroupColumnComboBox
//
/// <summary>
/// Represents a ComboBox that lets the user select a column from the group
/// table.
/// </summary>
///
/// <remarks>
/// Call <see cref="ColumnComboBox.PopulateWithTableColumnNames" /> to populate
/// the ComboBox with the group table column names.
/// </remarks>
//*****************************************************************************

public class GroupColumnComboBox : ColumnComboBox
{
    //*************************************************************************
    //  Constructor: GroupColumnComboBox()
    //
    /// <summary>
    /// Initializes a new instance of the <see cref="GroupColumnComboBox" />
    /// class.
    /// </summary>
    //*************************************************************************

    public GroupColumnComboBox()
    {
        // (Do nothing.)
