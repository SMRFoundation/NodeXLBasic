...
/// workbook to and from values in the NodeXL graph.
/// </summary>
///
/// <remarks>
/// This class is parameterized for the type of the values used in the NodeXL
/// graph.
///
/// <para>
...
public abstract class TextValueConverterBase <T> : Object
{
    ...
    /// of each pair is a value used in the NodeXL graph, and the second
