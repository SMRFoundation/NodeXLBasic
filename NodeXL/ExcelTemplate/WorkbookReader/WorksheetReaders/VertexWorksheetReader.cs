...
public class VertexWorksheetReader : WorksheetReaderBase
{
    ...
    /// </param>
    ///
    /// <param name="bLayoutAndZOrderSet">
    /// Gets set to true if vertex layout and z-order were specified for at
    /// least one vertex, or false otherwise.
    /// </param>
    //*************************************************************************
    ...
    //*************************************************************************
    //  Method: ReadLayoutAndZOrder()
    //
    /// <summary>
    /// If layout and z-orders have been specified for a vertex, sets the
    /// vertex's layout and z-orders.
    /// </summary>
    ///
    /// <param name="oRow">
    /// Row containing the vertex data.
    ...
    ///
    /// <param name="oVertex">
    /// Vertex to set the layout and z-orders on.
    /// </param>
    ///
    /// <returns>
    /// true if layout and z-orders were specified.
    /// </returns>
    //*************************************************************************
    ...
    //*************************************************************************
    //  Method: SetUnspecifiedVertexLayoutAndZOrders()
    //
    /// <summary>
    /// Sets a default layout and z-order for each vertex that doesn't already
    /// specify one.
    /// </summary>
    ///
    /// <param name="oGraph">
