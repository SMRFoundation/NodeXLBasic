...
namespace Smrf.NodeXL.ExcelTemplate {
    ...
    internal class GraphMetricDescriptions {
        ...
        ///	
        ///&lt;p&gt;
        ///You can have NodeXL create an edge based on the similarity of the content used by two vertices. Select a column of space or comma delimited words from the Vertices worksheet, and set the threshold of similarity required to create a new edge. NodeXL will calculate the level of similarity between each pair of vertices based on the following algorithm:
        ///&lt;/p&gt;
        ///
        ///&lt;p&gt;
        ///&lt;b&gt;Similarity (%) = number [rest of string was truncated]&quot;;.
        /// </summary>
        internal static string EdgeCreation {
            get {
                return ResourceManager.GetString("EdgeCreation", resourceCulture);
            }
        }
