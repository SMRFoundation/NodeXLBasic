...
public abstract class GraphMetricColumn : Object
{
    ...
    /// cref="ExcelTableUtil.AutoColumnWidth" /> to set the width
    /// automatically.
    /// </param>
    ///
    ...
    )
    {
        ...
        m_sStyle = style;
        m_bConvertUrlsToHyperlinks = false;
    ...
    //*************************************************************************
    //  Property: ConvertUrlsToHyperlinks
    //
    /// <summary>
    /// Gets or sets a flag indicating whether any URLs in the column should be
    /// converted to Excel hyperlinks.
    /// </summary>
    ///
    /// <value>
    /// true to convert any URLs to Excel hyperlinks after the column is
    ...
    ConvertUrlsToHyperlinks
    {
        get
        {
            ...
            return (m_bConvertUrlsToHyperlinks);
        }

        set
        {
            m_bConvertUrlsToHyperlinks = value;
    ...
    AssertValid()
    {
        ...
        Debug.Assert(m_fColumnWidthChars == ExcelTableUtil.AutoColumnWidth ||
            m_fColumnWidthChars > 0);

        // m_sNumberFormat
        // m_sStyle
        // m_bConvertUrlsToHyperlinks
    }
    ...
    protected Boolean m_bConvertUrlsToHyperlinks;
}
