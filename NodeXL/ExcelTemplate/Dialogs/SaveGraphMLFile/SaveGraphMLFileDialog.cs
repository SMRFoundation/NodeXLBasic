...
public class SaveGraphMLFileDialog : SaveGraphFileDialog
{
    //*************************************************************************
    //  Constructor: SaveGraphMLFileDialog()
    //
    /// <summary>
    /// Initializes a new instance of the <see cref="SaveGraphMLFileDialog" />
    /// class.
    /// </summary>
    ///
    ...
    )
    {
        ...
        try
        {
            ( new GraphMLGraphAdapter() ).SaveGraph(
