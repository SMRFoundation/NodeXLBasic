...
/// a Dynamic Filter column added to the edge table, and another formula written
...
public partial class DynamicFilterDialog : ExcelTemplateForm
{
    ...
    /// cref="Smrf.NodeXL.Core.ReservedMetadataKeys.Visibility" /> value
    /// of <see cref="Smrf.NodeXL.Core.VisibilityKeyValue.Filtered" />.
    ...
    //*************************************************************************
    //  Method: InitializeAndRecalculateDynamicFilterColumns()
    //
    /// <summary>
    /// Initializes the dialog's dynamic filter controls and recalculates
    /// specified dynamic filter columns.
    /// </summary>
    //*************************************************************************

    protected void
    InitializeAndRecalculateDynamicFilterColumns()
    {
        AssertValid();
    ...
    //*************************************************************************
    //  Method: AppendConditions()
    //
    /// <summary>
    /// Appends a pair of conditions to the Excel conditions being built for
    /// filtering.
    /// </summary>
    ///
    /// <param name="oDynamicFilterConditions">
    ...
    /// The column name the conditions apply to.
    /// </param>
    ///
    /// <param name="sSelectedMinimumAddress">
    /// The cell address of the minimum value in the selected range.
    /// </param>
    ///
    /// <param name="sSelectedMaximumAddress">
    /// The cell address of the maximum value in the selected range.
    /// </param>
    //*************************************************************************
    ...
    //*************************************************************************
    //  Method: EscapeColumnName()
    //
    /// <summary>
    /// Escapes special characters within a column name for use within an Excel
    /// condition.
    /// </summary>
    ///
    /// <param name="sColumnName">
    ...
    ///
    /// <returns>
    /// <paramref name="sColumnName" /> with any special characters replaced.
    /// </returns>
    //*************************************************************************
    ...
    )
    {
        ...
        oDynamicFiltersUserSettings.Save();
    }
    ...
    //*************************************************************************
    //  Method: chkDoNotFilterNonNumericCells_CheckedChanged()
    //
    /// <summary>
    /// Handles the CheckedChanged event on the chkDoNotFilterNonNumericCells
    /// CheckBox.
    /// </summary>
    ///
    /// <param name="sender">
    ...
    private void
    chkDoNotFilterNonNumericCells_CheckedChanged
    (
        object sender,
        EventArgs e
    )
    ...
    protected const Int32 MaximumDynamicFiltersPerTable = 120;
    ...
    /// true if control events should be handled.
