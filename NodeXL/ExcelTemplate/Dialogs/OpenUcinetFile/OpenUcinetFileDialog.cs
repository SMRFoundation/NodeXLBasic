...
public partial class OpenUcinetFileDialog : ExcelTemplateForm
{
    ...
    //
    /// <summary>
    /// Gets the name of the UCINET file that was opened.
    /// </summary>
    ///
    /// <value>
    /// The name of the UCINET file that was opened.
    /// </value>
    ///
    /// <remarks>
    /// This can be used by the caller after the dialog exits to determine
    /// which UCINET file was opened.
    /// </remarks>
    //*************************************************************************
    ...
    FileName
    {
        get
        {
            ...
            return (m_oOpenUcinetFileDialogUserSettings.FileName);
        }
    }
    ...
    OpenUcinetFile()
    {
        ...
        m_oGraph = ( new UcinetGraphAdapter() ).LoadGraph(this.FileName,
            m_oOpenUcinetFileDialogUserSettings.FileDirectedness);
    }
...
[ SettingsGroupNameAttribute("OpenUcinetFileDialog2") ]
