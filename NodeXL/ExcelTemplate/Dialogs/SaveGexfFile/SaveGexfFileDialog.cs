...
{
//*****************************************************************************
//  Class: SaveGexfFileDialog
//
/// <summary>
/// Represents a dialog box for saving a graph to a GEXF file.
/// </summary>
///
/// <remarks>
...
public class SaveGexfFileDialog : SaveGraphFileDialog
{
    //*************************************************************************
    //  Constructor: SaveGexfFileDialog()
    //
    /// <summary>
    /// Initializes a new instance of the <see cref="SaveGexfFileDialog" />
    /// class.
    /// </summary>
    ///
    ...
    )
    {
        ...
        try
        {
            ( new GexfGraphAdapter() ).SaveGraph( (IGraph)oObject, sFileName ); 
        }
