...
public class ExcelTemplateForm : FormPlus
{
    ...
    )
    {
        ...
        while (true)
        {
            ...
            {
                // Known bug: Selecting some fonts in the dialog, such as
                // Visual UI, throws an ArgumentException of "Only TrueType
                // fonts are supported. This is not a TrueType font."  See the
                // following post:
                //
                // http://social.msdn.microsoft.com/Forums/en-US/vbgeneral/
                // thread/e50a3dc2-a9d9-4eea-aae6-39bc7c18b04e

                this.ShowWarning(
                    "That font won't work with NodeXL.  Please select a"
                    + " different font."
                    );
            }
        }
