...
/// for a destination column that gets autofilled with a range of colors mapped
/// from the numbers in a source column.
/// </remarks>
//*****************************************************************************
...
public class ColorColumnAutoFillUserSettings : Object
{
    ...
    {
        m_bSourceColumnContainsNumbers = true;
        ...
        m_eDestinationColor1 = Color.FromArgb(241, 137, 4);
        m_eDestinationColor2 = Color.FromArgb(46, 7, 195);
    ...
    //
    /// <summary>
    /// Gets or sets a flag indicating whether the source column contains
    /// numbers.
    /// </summary>
    ///
    /// <value>
    ...
    ///
    /// <remarks>
    /// If true, the source column contains numbers and the destination column
    /// gets autofilled with a range of colors calculated from the source
    /// column numbers.  If false, the source column contains categories and
    /// the destination column gets autofilled with a unique color for each
    /// category.
    /// </remarks>
    //*************************************************************************
    ...
    SourceColumnContainsNumbers
    {
        ...
        set
        {
            m_bSourceColumnContainsNumbers = value;
