...
{
//*****************************************************************************
//  Class: UserSettingsTypeConverterBase
//
/// <summary>
/// Base class for several user-settings-related type converters that can
...
public class UserSettingsTypeConverterBase : TypeConverter
{
    //*************************************************************************
    //  Constructor: UserSettingsTypeConverterBase()
    //
    /// <summary>
    ...
    public UserSettingsTypeConverterBase()
    {
        // (Do nothing.)
