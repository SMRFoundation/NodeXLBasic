...
///
/// <para>
/// A <see cref="RequestEdgeCommandEnable" /> or <see
/// cref="RequestVertexCommandEnable" /> event is fired before an edge or
/// vertex table context menu is displayed and this class needs to know which
/// menu items to enable.  A <see cref="RunNoParamCommandEventArgs" /> command
/// is sent via the <see cref="CommandDispatcher" /> class when the user clicks
/// one of the custom menu items.
/// </para>
/// 
/// </remarks>
//*****************************************************************************
