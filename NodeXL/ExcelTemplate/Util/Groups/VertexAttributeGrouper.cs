...
public static class VertexAttributeGrouper
{
    ...
    //*************************************************************************
    //  Embedded class: GroupOther
    //
    /// <summary>
    /// Represents a group created using the values in a vertex column of
    /// type <see cref="ExcelColumnFormat.Other" />.
    /// </summary>
    //*************************************************************************

    private class GroupOther : Object
    {
        /// The group's name.
        ...
        public LinkedList<IVertex> Vertices = null;
    }
}
