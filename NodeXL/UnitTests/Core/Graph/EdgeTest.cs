...
public class EdgeTest : Object
{
    ...
    TestConstructor()
    {
        ...
        Assert.AreEqual(oVertex1, oEdge.Vertex1);
        Assert.AreEqual(oVertex2, oEdge.Vertex2);
    ...
    //*************************************************************************
    //  Method: TestVertex1And2Vertex()
    //
    /// <summary>
    /// Tests the Vertex1 and Vertex2 properties.
    /// </summary>
    //*************************************************************************
    ...
    TestVertex1And2Vertex()
    {
        ...
        Assert.AreEqual(oVertex2, oEdge.Vertex1);
        Assert.AreEqual(oVertex1, oEdge.Vertex2);
    }
    ...
    TestVertices()
    {
        ...
        Assert.IsNotNull( oEdge.Vertices[0] );
        Assert.AreEqual( oVertex1, oEdge.Vertices[0] ); 
        Assert.AreEqual( oEdge.Vertex1, oEdge.Vertices[0] ); 

        Assert.IsNotNull( oEdge.Vertices[1] );
        Assert.AreEqual( oVertex2, oEdge.Vertices[1] ); 
        Assert.AreEqual( oEdge.Vertex2, oEdge.Vertices[1] ); 
    }
