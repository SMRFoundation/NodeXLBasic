...
public class DuplicateEdgeDetectorTest : Object
{
    ...
    /// The "null name" cases are a vestige of a previous implementation of
    /// DuplicateEdgeDetector that used vertex names instead of IDs to detect
    /// duplicates.  These cases are retained to verify that missing vertex
    /// names don't cause a problem.
