...
/// implements <see cref="ILayout" />.  It provides a <see cref="Layout" />
/// property for keeping track of the layout type currently in use, a <see
/// cref="LayoutChanged" /> event that is raised when the layout is changed,
/// and a <see cref="CreateLayout" /> method for creating a layout of the
/// current type.
///
/// <para>
