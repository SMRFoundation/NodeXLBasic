...
namespace Smrf.NodeXL.ApplicationUtil
{
//*****************************************************************************
...
public partial class GraphZoomAndScaleControl : UserControl
{
    ...
    public GraphZoomAndScaleControl()
    {
        ...
        // Use only a portion of the available GraphScale range.

        Debug.Assert(MinimumGraphScale >= NodeXLControl.MinimumGraphScale);
        Debug.Assert(MaximumGraphScale <= NodeXLControl.MaximumGraphScale);

        tbGraphScale.Minimum =
            NodeXLControlValueToTrackBarValue(MinimumGraphScale);

        tbGraphScale.Maximum =
            NodeXLControlValueToTrackBarValue(MaximumGraphScale);
    ...
    protected const Double MinimumGraphScale = 0.1;
    ///
    protected const Double MaximumGraphScale = 1.0;
