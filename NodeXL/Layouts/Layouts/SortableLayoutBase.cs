...
public abstract class SortableLayoutBase : LayoutBase
{
    //*************************************************************************
    ...
    //*************************************************************************
    //  Method: UseMetadataVertexSorter()
    //
    /// <summary>
    ...
    ///
    /// <remarks>
    /// If <paramref name="graph" /> has the key <see
    /// cref="ReservedMetadataKeys.SortableLayoutAndZOrderSet" />, this method
    /// sets the <see cref="VertexSorter" /> property to an object that will
    /// sort the graph's vertices by the values contained in the vertices' <see
    /// cref="ReservedMetadataKeys.SortableLayoutAndZOrder" /> keys.
    /// Otherwise, it sets the <see cref="VertexSorter" /> property to null.
    /// </remarks>
    //*************************************************************************
