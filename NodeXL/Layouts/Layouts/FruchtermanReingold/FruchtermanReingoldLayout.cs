...
/// <para>
/// If the graph has a metadata key of <see
/// cref="ReservedMetadataKeys.LayoutBaseLayoutComplete" />, the previous
...
///
/// <para>
/// If an edge has a metadata key of <see
/// cref="ReservedMetadataKeys.EdgeWeight" />, the edge weight is used in the
...
public class FruchtermanReingoldLayout : LayoutBase
{
    //*************************************************************************
    ...
    )
    {
        ...
        Object oTag = oVertexOrEdge.Tag;

        if (oTag != null)
        {
            oVertexOrEdge.SetValue(
    ...
    )
    {
        ...
        Object oTag = oVertexOrEdge.GetValue(
            ReservedMetadataKeys.FruchtermanReingoldLayoutTagStorage);

        oVertexOrEdge.Tag = oTag;

        if (oTag != null)
        {
            oVertexOrEdge.RemoveKey(
                ReservedMetadataKeys.FruchtermanReingoldLayoutTagStorage);
        }
    }
