...
namespace Smrf.NodeXL.GraphDataProviders.Facebook
{
    ...
    public class FacebookGroupGraphDataProvider : GraphDataProviderBase
    {
        //*************************************************************************
        ...
        public FacebookGroupGraphDataProvider()
            :
            base(GraphDataProviderName,
                "Facebook Group Importer")
        {
            // (Do nothing.)
        ...
        CreateDialog()
        {
            ...
            return (new FacebookGroupDialog());
        }
