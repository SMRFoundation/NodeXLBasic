    ...
    public partial class FacebookGroupDialog : FacebookGraphDataProviderDialogBase
    {
        ...
        StartAnalysis()
        {
            ...
            try
            {
                ...
                FacebookGroupModel oModel = new FacebookGroupModel();
                ...
                oModel.RelationshipCommentAuthor = chkRelationshipCommentAuthor.Enabled && chkRelationshipCommentAuthor.Checked;
        ...
        {            
            ...
            o_fcbLoginDialog = new FacebookLoginDialog(this, 
                                    UserAttributes.createRequiredPermissionsString(
                                                    chkStatusUpdates.Checked, false,true));
        ...
        private void SetEdgesLabelText()
        {
            ...
            chkRelationshipCommentAuthor.Text = String.Format(m_sRelationshipCommentAuthorCheckboxText, GetRelationshipNamingsText("noun"));
        }
        ...
        private void chkEdges_CheckedChanged(object sender, EventArgs e)
        {
            ...
            chkRelationshipCommentAuthor.Checked = chkRelationshipCommentAuthor.Enabled && bChkEdgesChkecked;
