...
{
    public partial class FacebookNewsFeedDialog : FacebookGraphDataProviderDialogBase
    {
        public FacebookNewsFeedDialog()
            :
        ...
        StartAnalysis()
        {
            ...
            try
            {
                ...
                //oModel.Friends = chkFriends.Checked;
                //oModel.FriendsTimeline = chkMyFriendTimeline.Checked;
                ...
                //oModel.MyTimeline = chkMyTimeline.Checked;
        ...
        {
            chkIncludeMe.Enabled = chkFriends.Checked;
        }
